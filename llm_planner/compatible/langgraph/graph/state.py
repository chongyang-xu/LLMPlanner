# ported from   libs/langgraph/langgraph/graph/state.py
...
from llm_planner.compatible.langgraph.graph.graph import END, START, Branch, CompiledGraph, Graph, Send
from llm_planner.compatible.langgraph.lc_core.runnables import Runnable, RunnableConfig

from pydantic import BaseModel
from pydantic.v1 import BaseModel as BaseModelV1
from typing_extensions import Self

from llm_planner.compatible.langgraph.types import All, Checkpointer, Command, RetryPolicy
from llm_planner.compatible.langgraph.constants import EMPTY_SEQ, TAG_HIDDEN
...
class LangGraphDeprecationWarning:
    pass
...
class ChannelKeyPlaceholder:
    pass

class ChannelTypePlaceholder:
    pass

class ConfiguredManagedValue:
    pass

class ManagedValueSpec:
    pass

def is_managed_value():
    pass

def is_writable_managed_value():
    pass
...
from llm_planner.compatible.langgraph.utils.runnable import RunnableCallable, RunnableLike, coerce_to_runnable
